...
<html>
	...
	<body>
		...
		<div id="homeBody">
			...
			<h1>CSCB20 PAST EXAMS</h1>
			<hr>

			<ul>
				<li><a href="#">Fall 2012</a></li>
				<li><a href="#">Fall 2012 solution</a></li>
			</ul>

			<ul>
				<li><a href="#">Fall 2014</a></li>
				<li><a href="#">Fall 2014 solution</a></li>
			</ul>
			
			<ul>
				<li><a href="#">Winter 2017</a></li>
				<li><a href="#">Winter 2017 solution</a></li>
			</ul>
			
			<ul>
				<li><a href="#">Fall 2018</a></li>
				<li><a href="#">Fall 2018 solution</a></li>
			</ul>
