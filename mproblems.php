...
<html>
	...
	<body>
		...
		<div id="homeBody">
			...
			<h1>CSC B20 additional problems</h1>
			<hr>

			<ul>
				<li><a href="#">Problems regarding relational algebra</a></li>
				<li><a href="#">Problems regarding SQL tables</a></li>
				<li><a href="#">Problems regarding SQL Queries</a></li>
				<li><a href="#">Problems regarding HTML</a></li>
				<li><a href="#">Problems regarding CSS</a></li>
				<li><a href="#">Problems regarding javascript</a></li>
				<li><a href="#">Problems regarding PHP</a></li>
			</ul>

			<p>Refer to these for additional practice if you need it</p>
